...
<body>
    <div class='body'>
        <h1 style="color: blue;">Orden creada correctamente </h1>
        <p>Estimado {{$ordene->destinatarioorden->nombre}} {{$ordene->destinatarioorden->apellido1}} {{$ordene->destinatarioorden->apellido2}}</p>
        <p>La orden numero {{$ordene->numero}} ha sido creada correctamente y se encutran en estado de {{$ordene->estado}}</p>
